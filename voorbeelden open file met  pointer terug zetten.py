...
#                     ###           24 random woorden      ###
#                     ########################################
# Purpose:     Op het oog is de tekst volledige versleuteld echter het is wel
#              mogelijk om deze tekst te lezen. De kunst is welke 'krakeling'
#              wordt er genomen. Maar uiteindelijk gaat ontcijferen makkelijker
